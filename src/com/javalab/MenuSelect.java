...
public class MenuSelect {
	...
	public void selectMenu() {
		while (true) {
			...
			case 2: // 교수 등록
				while (true) {
					System.out.println("2.교수등록 메뉴를 선택하였습니다.");
			...
			case 3: // 학과등록
				while (true) {
					System.out.println("3.학과등록 메뉴를 선택하였습니다.");
			...
			case 4: // 성적 등록
				while (true) {
					System.out.println("4.성적등록 메뉴를 선택하였습니다.");
					System.out.println("학과코드?");
					String id = scanner.next();
					System.out.println("학과명?");
			...
			case 5: // 학생 목록 조회
				System.out.println("5. 학생 목록 조회를 선택하였습니다.");
				studentList.forEach(System.out :: println);
				System.out.println("5. 학생 목록 조회를 완료하였습니다.");
				break;
	
			case 6: // 교수 목록 조회
				System.out.println("6. 교수 목록 조회를 선택하였습니다.");
				professorList.forEach(System.out :: println);
				System.out.println("6. 교수 목록 조회를 완료하였습니다.");
				break;
			case 7: // 학과 목록 조회
				System.out.println("7. 학과 목록 조회를 선택하였습니다.");
				departmentList.forEach(System.out :: println);
				System.out.println("7. 학과 목록 조회를 완료하였습니다.");
				break;
			case 8: // 성적 목록 조회
				System.out.println("8. 성적 목록 조회를 선택하였습니다.");
				takesList.forEach(System.out :: println);
				System.out.println("8. 성적 목록 조회를 완료하였습니다.");
				break;
			case 9: // 종료
